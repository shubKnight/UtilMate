        ...
        content: SingleChildScrollView(
          child: Column(
            children: [
              ...
              TextField(controller: _priceController, decoration: InputDecoration(labelText: "Price (Rs.)")),
              TextField(controller: _specsController, decoration: InputDecoration(labelText: "Specs"), maxLines: 3),
              TextField(controller: _itemsController, decoration: InputDecoration(labelText: "No. of items"), keyboardType: TextInputType.number),
            ],
          ),
        ),
        actions: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.add), onPressed: _showAddProductDialog),
        ],
      ),
      body: StreamBuilder(
